...
{	public int id=0;
	...
	public void cancelBtn(ActionEvent event) throws IOException, InterruptedException
	{	
		{((Node)event.getSource()).getScene().getWindow().hide();//Hide Menu
		
		ArrayList<String> directory = new ArrayList<String>();
		String cmd ="SELECT orderID, type,date, price FROM zerli.orders where customerID=1;";
		...
		directory = (ArrayList<String> )client.msg;
